...
// LINK redux action
import { refSearchMenu, closeProfileModal } from "../../Redux/Actions/Index";
...
const Search = ({ searchActive, searchHandler }) => {
  ...
  const closeProfileModalACction = () => dispatch(closeProfileModal());
  ...
  const activeInput = (e) => {
    e.stopPropagation();
    console.log("isTriggered active");
