...
const HomeBooking = () => {
  ...
  const { cardNum, CVV, expDate, zipCode, region } = state;
  ...
  const setInputValue = () => {
    fetch("http://localhost:3000/game", {
      ...
      body: JSON.stringify({
        stay: 1,
        checkin_date: 20201109,
        checkout_date: 20201120,
        guest_number: guestSum,
        price: 1300000,
        creditcard: { cardNum },
      }),
    }).then((res) => res.json());
        ...
        <InfoArea>
          ...
          <RefundPolicy>
            ...
            <PolicyWrapper>
              ...
              <ChosenDate>
                11월 10일 3:00 PM까지 무료로 취소할 수 있습니다. 그 후에는 11월
                15일 3:00 PM 전에 예약을 취소하면 첫 1박 요금 및 서비스 수수료를
                제외한 요금의 50%가 환불됩니다.
              </ChosenDate>
            </PolicyWrapper>
          </RefundPolicy>
          ...
          <RequestButton onClick={handleConfirm}>확인 및 결제</RequestButton>
        </InfoArea>
        <SummaryArea>
          <SummaryBox>
            <div className="homeSummary">
              <img
                alt="homeImg"
                src="https://a0.muscache.com/im/pictures/0d15e44c-b184-4a6f-b540-b8611d6b0673.jpg?aki_policy=large"
              />
              <div className="homeDescription">
                <div className="homeLocation">성동구의 레지던스의 객실</div>
                <div className="homeTitle">
                  ★리뉴얼★LTERoom2★ Wangsimni 1min, City View
                </div>
                <div className="NumOfFacility">침대 2개 · 욕실 1개</div>
                <div className="Rating">
                  <div className="guestRating">
                    <FontAwesomeIcon
                      ...
                      icon={faStar}
                    />
                    <b>{stay.length > 0 && stay[0]["review"]["avr_score"]}</b>(
                    {stay.length > 0 && stay[0]["review"]["reviews"]})
                  </div>
                  {stay.length > 0 && stay[0]["hostInfo"]["superHost"] && (
            ...
            <div className="paymentSummary">
              ...
              <ClaimWrapper>
                ...
                <TotalPrice>
                  ₩
                  {stay.length > 0 &&
                    (stay[0]["price"] * Number(dates) + 165000 + 26400 + 2640)
                      .toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                </TotalPrice>
              </ClaimWrapper>
