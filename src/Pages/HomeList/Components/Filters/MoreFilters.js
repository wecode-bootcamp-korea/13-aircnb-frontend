            ...
            <div>
              <div>
                ...
                <div className="counter">
                  <button
                    onClick={() =>
                      num.beds !== 0 && setNum({ ...num, beds: num.beds - 1 })
                    }
                  >
                    &minus;
                  </button>
                  ...
                  <button
                    onClick={() => {
                      num.beds < 4 && setNum({ ...num, beds: num.beds + 1 });
                    }}
                  >
                    +
                  </button>
              ...
              <div>
                ...
                <div className="counter">
                  ...
                  <button
                    onClick={() => {
                      num.rooms < 4 && setNum({ ...num, rooms: num.rooms + 1 });
                    }}
                  >
                    +
                  </button>
              ...
              <div>
                ...
                <div className="counter">
                  <button
                    onClick={() =>
                      num.bathrooms !== 0 &&
                      setNum({ ...num, bathrooms: num.bathrooms - 1 })
                    }
                  >
                    &minus;
                  </button>
